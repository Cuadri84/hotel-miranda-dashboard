...
export const UserRow = (user) => {
  ...
  return (
    <Row
      onClick={() => {
        goToSingleUser(user.user.id);
      }}
    >
      <td>
        <UserContainer>
          <img src={user.user.photo} alt="User portrait" />
          <div>
            <UserName>{user.user.name}</UserName>
            <UserID>#{user.user.id}</UserID>
            <UserJoinDate>Joined on {user.user.date}</UserJoinDate>
          </div>
        </UserContainer>
      </td>
      ...
      <td>
        <Status $type={user.user.state}>{user.user.state}</Status>
      </td>
            ...
            <ul>
              ...
              <li>
                <button
                  onClick={(e) => {
                    if (e && e.stopPropagation) e.stopPropagation();
                    deleteCurrentUser(e, user.user.id);
                  }}
                >
                  Delete user
                </button>
