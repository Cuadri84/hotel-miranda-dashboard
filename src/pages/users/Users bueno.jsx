...
export const Users = () => {
  ...
  const [usersTypeFilter, setUsersTypeFilter] = useState("");
  const users = usersList.filter(
    (user) => !usersTypeFilter || user.state === usersTypeFilter
  );
  ...
  return (
    <>
      <TableActions>
        <TableFilters>
          <FilterButton onClick={() => setUsersTypeFilter("")}>
            All Employees
          </FilterButton>
          <FilterButton onClick={() => setUsersTypeFilter("ACTIVE")}>
            Active Employees
          </FilterButton>
          <FilterButton onClick={() => setUsersTypeFilter("INACTIVE")}>
            Inactive Employees
          </FilterButton>
        </TableFilters>
